...
Push to Render and make sure everything still works.  Give yourself a break and play a few rounds of wordguesser.
...
-----------------------
When all scenarios are passing, deploy to Render and submit the URL of your deployed game in a file named `sinatra-url.txt`. 
